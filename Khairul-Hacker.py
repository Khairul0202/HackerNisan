...
#        along with this program.  If not, see <https://www.facebook.com/i.love.you.nisan/>.
#
#
#
#     I Love You Khairul Islam🧨🧨
#    
#    
#    About Author :
#    
#    Founder : 0x0ptim0us (Fardin Allahverdinazhand)
#    Location : pabna -Sujanagar
#    Email : donkh50@Gmail.com
#    Project In SourceForge : https://www.facebook.com/i.love.you.nisan
#    Blog : https://www.facebook.com/i.love.you.nisan
#
import os
...
def main():
    try:
        ...
        print(wcolors.color.YELLOW + "[*] Thank You For Using 🧨🧨❣NisaN =)" + wcolors.color.ENDC)
def start():
    header.main_header()
    menu.main_info()
    main()
